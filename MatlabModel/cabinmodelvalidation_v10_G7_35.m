...
vent_volumerate=0.00015; % m3/s, Faya 2013: 0.02; 0.001
...
for t=2:Total_time
    ...
    heat_human(t) = h_cabin*A_skin*(temperature(13)-T_skin) ;
    ...
    if ( (TC_back(t)+273.15-temperature(14)) < 0)
        delta_temp_tailpipe_mean(t) = -0.0001;
    else
        delta_temp_tailpipe_mean(t) = (TC_back(t)+273.15-temperature(14)); % K
    end
     
    Qengine_observed_G7_35(t) = cp_air*CabinVolume/2*density_air*(delta_temp_engine_mean(t))/timestep;
    Qexhaust_observed_G7_35(t) = cp_air*CabinVolume/2*density_air*(delta_temp_tailpipe_mean(t))/timestep;
    
    Qengine_observed(t) = Qengine_observed_G7_35(t);
    Qexhaust_observed(t) = Qexhaust_observed_G7_35(t);
...
% save Engine_thermal_loads_W_G7_35_v10 Qengine_observed_G7_35 Qexhaust_observed_G7_35
...
legend('Total cabin','Ambient','Human','Equipment','Engine','Exhaust','Vents','Leakage','Emitted','MAC needed','Location','eastoutside')
grid minor
xlim([0 1800])
