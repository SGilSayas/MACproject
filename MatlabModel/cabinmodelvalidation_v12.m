...
reduced_amplitude = 1; % 1 for yes, 0 for no
reduction = 5; 
...
%% Load input cell humidity and pressure (hypothesis: all cases same)
...
hold on
plot(time,Qcabin_received_plot,':','LineWidth',1.5)
...
hold on
plot(time,Qmac_needed_plot,'-','LineWidth',1.5)
ylabel('Q cooling MAC [W]')
%set(gca,'Ydir','reverse')
legend('Total','Cabin received','Ambient','Human','Equipment','Engine','Exhaust','Vents','Leakage','Emitted','MAC needed','Location','northeastoutside')
grid minor
% xlim([0 1800])
