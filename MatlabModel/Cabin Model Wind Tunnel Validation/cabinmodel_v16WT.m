...
reduction = 5; 
%% Load Wind Tunnel Data first option
% if(WT==1)
...
%     timeWT = transpose(1:2:length(TC_cell));  
% end
% % Resampling:
% TC_pass = TC_pass(1:1800,:);
% TC_vent = TC_vent(1:1800,:);
% TC_backpass = TC_backpass(1:1800,:);
% TC_driver = TC_driver(1:1800,:);
% TC_front = TC_front(1:1800,:);
% TC_back = TC_back(1:1800,:);
% TC_cell = TC_cell(1:1800,:);
% timeWT = transpose(1:2:length(TC_cell)*2);  
%% Read wind tunnel data of sones 3, 4 and 5
