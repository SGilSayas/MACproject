...
for t=2:Total_time
    ...
    A_front = 3.5; %2.7*A_ws + A_dashboard;
    A_back = 2; %A_rw;
    A_side = A_sidewindows*5;
    h_side(t) = 0.95*h_front(t); % 0.95
    ...
    UA_front = A_front*U_front(t) + 0.5*(A_side*U_side(t));
    UA_back = A_back*U_back(t) + 0.5*(A_side*U_side(t));
...
alert = ['Vehicle reached higher speed than WLTC limits during: ',num2str(high_speed_index),' seconds.'];
disp(alert)
A_front
A_back
A_side
