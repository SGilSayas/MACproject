...
elseif(G7_35==1 || G8_35==1 || I5PV_macoff)
...
for t=1:Total_time
    ...
    T_engine(t) = 273.15 + (-2*10^(-6)*engine_rpm(t)^(2) + 0.0355*engine_rpm(t) + 50 ); %K
    T_exhaust(t) = 273.15 + (-2*10^(-6)*engine_rpm(t)^(2) + 0.0138*engine_rpm(t)); %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    Tbc=[T_cell(t);
        -Qhuman(t)/2-Qirr(t)/2-Qbase(t)/2-Qengine(t); %-Qhuman(t)-Qengine(t)-Qvent(t)-Qirr(t)/2-Qbase(t)/2;
        -Qhuman(t)/2-Qirr(t)/2-Qbase(t)/2-Qexhaust(t)]; %-Qequipment(t)-Qexhaust(t)-Qleakage(t)-Qirr(t)/2-Qbase(t)/2];
