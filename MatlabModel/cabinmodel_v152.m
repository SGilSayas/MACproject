% Vehicle's Cabin Model, Susana Gil-Sayas. Version: 15.2 new Qtarget, but
...
for t=2:Total_time
    ...
    % Qengine_observed(t)=0; % Qengine(t) = Qengine_observed(t) + Qengine_calc(t);
    % Qexhaust_observed(t)=0; % Qexhaust(t) = Qexhaust_observed(t) + Qexhaust_calc(t);
...
Qcabin_W_av = cabin_in_W_av - cabin_out_W_av
