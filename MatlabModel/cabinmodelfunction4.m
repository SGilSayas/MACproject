function [Tcabin,Qcompressor,compressor_av_W,comp_Wh_WLTP,CO2_total] = cabinmodelfunction4(Total_time,distance_driven,N_Humans,COP,TC_cabin_ini,TC_cell_constant,Irr_constant,TC_cell,Irr,category,fuel)
