...
%T_amb = [T_ini;T_ini;T_ini;T_ini;T_ini;T_ini;T_ini;T_ini;T_ini;T_ini;T_ini;T_ini;T_ini;T_ini];
T_amb=T_ini;
...
Tbc=[T_amb;-A_roof*G_roof_a(t);0;-Qbase(t);-A_ws*G_ws_a(t);-A_rw*G_rw_a(t);-A_lsw*G_lsw_a(t);-A_rsw*G_rsw_a(t);0;0;0;0;-Qhuman(t);0]; 
...
figure(3)
plot(time,Tcabin_front,'b',time,Tcabin_back,'r')
legend('T cabin front','T cabin back','Location','best')
grid on
grid minor
xlabel('Time [s]') 
