...
% May 2021, upgrade to lumped model (13 and 14 nodes)
clc
clear all 
close all
%% INPUTS
...
Tbc=[T_amb(t);-A_roof*G_roof_a(t);0;-Qbase(t);-A_ws*G_ws_a(t);-A_rw*G_rw_a(t);-A_lsw*G_lsw_a(t);-A_rsw*G_rsw_a(t);0;0;0;0;-Qhuman(t)]; 
